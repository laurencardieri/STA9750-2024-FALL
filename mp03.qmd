...
To complete this fact check, we will compare the effects of all of the Electoral College Votes allocation rules. 
...
I do not believe that this way of voting is fair, as it does not properly represent the voters of the minority party in each state. That is, if 51% of voters vote for Party A, while 49% vote for Party B, all of Party B's voices will not be heard. That is a large majority of people who are being misheard. Thus, let's go to the next voting option. 
